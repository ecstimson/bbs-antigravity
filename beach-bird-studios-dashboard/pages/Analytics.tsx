...
import { SearchConsoleWidget } from '../components/widgets/SearchConsoleWidget';
    ...
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-surface border border-border rounded-lg text-sm hover:bg-border transition-colors">
            <Calendar size={16} />
            Last 30 Days
          </button>
